...
public class SeznamPrikazu {
    ...
    public void vymazPrikaz(IPrikaz prikaz) {
        mapaSPrikazy.remove(prikaz.getNazev(),prikaz);
    }
    ...
    public boolean jePlatnyPrikaz(String retezec) {
        return mapaSPrikazy.containsKey(retezec) && mapaSPrikazy.get(retezec).jeAktivni();
    }
